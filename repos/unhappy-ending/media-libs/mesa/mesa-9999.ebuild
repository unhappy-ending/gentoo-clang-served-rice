...
pkg_pretend() {
	if use vulkan; then
		if ! use video_cards_d3d12 &&
		   ...
		   ! use video_cards_nouveau nouveau &&
		   ! use video_cards_v3d; then
			ewarn "Ignoring USE=vulkan     since VIDEO_CARDS does not contain d3d12, freedreno, intel, radeonsi, nouveau, or v3d"d
		fi
	fi
